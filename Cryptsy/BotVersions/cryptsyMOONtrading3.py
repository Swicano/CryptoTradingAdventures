...
Exchange = Cryptsy.Cryptsy('dfghfhfgh', 'dfghdfghdfgh');
...
bias = .25; #from 0-1, pick fraction of extra money that goes toward nonBTC/LTC currency (ie in doge/btc, bias =1 puts all profits into doge)
